...
function CV({ audience }: Readonly<CVProps>): JSX.Element {
	...
	const experiences = [
		{
			...
			description:
				"Industrialisation de la gestion des standards APIs REST et de la documentation pour un SI comprenant plus de 1000 APIs et des milliers de développeurs.",
			achievements: [
		...
		},
		{
			...
			description:
				"Accélération de l'adoption de la solution d'API Management Gravitee.",
			achievements: [
		...
		},
		{
			...
			description:
				"Architecture et développement d'une plateforme d'accès standardisée pour résoudre les connexions multiples et la gestion des contrats de données.",
			achievements: [
	...
	const softSkills = [
		{
			...
			title: "Pédagogie",
			description:
				"Formation de 200+ développeurs, conception de supports et animation de sessions",
		},
		{
			icon: "🤝",
			title: "Esprit d'équipe",
			description:
				"7+ années chez Decathlon, intégration durable et collaboration transverse",
		},
		{
			icon: "🎯",
			title: "Fiabilité",
			description:
				"Gestion proactive des missions, respect des engagements et des délais",
		},
		{
			icon: "🔄",
			title: "Adaptabilité",
			description:
				"Expertise dans des environnements hétérogènes (SAP, SaaS, stacks diverses)",
		},
	];
			...
			<section className="cv-hero visible">
				...
				>
					...
					<p className="cv-subtitle">
						Romain Tabary • Développeur Full-stack Senior Freelance & Expert API
						Management
					</p>
					<p className="cv-tagline">
						10+ ans d'expérience | TypeScript Ecosystem | API Governance
					</p>
			...
			<section className="cv-section profile-summary">
				<div className="container">
					...
					<div className="profile-content">
						<p>
							Expert technique cumulant plus de 10 ans d'expérience, spécialisé
							dans le <strong>Développement Fullstack</strong> (écosystème
							TypeScript) et la <strong>Gouvernance d'API</strong>.
						</p>
						<p>
							Mon expertise couvre l'intégralité du cycle de vie logiciel : de
							la conception d'architectures web robustes (NestJS/React) à
							l'industrialisation des processus de qualité, en passant par
							l'amélioration de la Developer Experience.
						</p>
						<p>
							J'ai évolué plus de 7 ans dans un contexte à forte échelle
							(Decathlon), contribuant à l'outillage critique (IDP, API
							Management) utilisé par des centaines de développeurs.
						</p>
					</div>
				</div>
			</section>
